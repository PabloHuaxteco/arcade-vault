// Home — landing y punto de entrada de Arcade Vault. Server Component que porta
// references/templates/home-about/home.jsx: helpers SVG como funciones del módulo,
// CTAs y enlaces como <Link>, y las secciones con scroll-reveal envueltas en la
// isla Client <Reveal>. Los datos de "Actividad en vivo", estadísticas y precios
...
function FloatingSilhouettes() {
  // Siluetas pixeladas decorativas de formas arcade clásicas.
  return (
...
function FeatureIcon({ kind }: { kind: FeatureKind }) {
  // Iconos pixel 16x16 dibujados con rects; el glow lo aporta el color del padre.
