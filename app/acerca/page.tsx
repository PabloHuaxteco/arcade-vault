// Página /acerca — "Acerca de" + formulario de contacto. Server Component que
// porta references/templates/home-about/about.jsx: helper SVG `HighlightIcon`
// como función del módulo, las secciones con scroll-reveal envueltas en la isla
// Client <Reveal> (SPEC 02) y el formulario como isla Client <ContactForm>, que
// envía de verdad con Resend a través de una Server Action (ver SPEC 03).
