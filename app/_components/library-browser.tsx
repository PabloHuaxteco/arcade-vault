...
// Buscador + chips de categoría + grid de tarjetas. Portado de la función
// Library de references/templates/biblioteca.jsx (sin la sección av-hero, que
// vive en app/page.tsx).
